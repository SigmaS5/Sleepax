...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/chart-custom.js":[function(require,module,exports) {
var _this = this;
...
var data;
var chart; // Fetch sleepWatch from db
...
choiceButtons.forEach(function (choiceButton) {
  choiceButton.addEventListener("click", function () {
    ...
    var existingNote = getSameDayNote(obj);

    if (existingNote) {
      var newVote = _objectSpread(_objectSpread({}, obj), {}, {
        id: existingNote.id
      });

      axios.put(urlApi + 'sleepWatch/' + existingNote.id, _objectSpread(_objectSpread({}, obj), {}, {
        id: existingNote.id
      })).then(function (resp) {
        var index = data.findIndex(function (el) {
          return el.id === existingNote.id;
        });
        _this.data[index] = newVote;
        initChart(data);
      }).catch(function (error) {
        return console.log(error);
      });
    } else {
      axios.post(urlApi + 'sleepWatch', obj).then(function (resp) {
...
function getSameDayNote(obj) {
  ...
  data.forEach(function (el) {
    var dateEl = el.date.split('T')[0];
    var today = obj.date.split('T')[0];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/chart-custom.js"], null)
//# sourceMappingURL=/chart-custom.e9057036.js.map